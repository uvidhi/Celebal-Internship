...
* SQL solutions for:
  ...
  * Section B – Filtering and Sorting
...
* Superstore dataset import
* Database creation
* Customers, Orders, and Products table creation
...
* Use of `count()`, `sum()`, `avg()`, `min()`, and `max()`
* Schema modification and data type casting
